...
# -*- coding: utf-8 -*-
#
# clink documentation build configuration file, created by
# sphinx-quickstart on Tue May  2 23:43:54 2017.
#
...
sys.path.append(path.join(root, 'venv'))
...
latex_documents = [
    (master_doc, 'clink.tex', 'clink Documentation',
     'Kevin Leptons', 'manual'),
]
...
man_pages = [
    (master_doc, 'clink', 'clink Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'clink', 'clink Documentation',
     author, 'clink', 'One line description of project.',
     'Miscellaneous'),
]
